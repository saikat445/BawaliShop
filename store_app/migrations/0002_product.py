# Generated by Django 3.2.16 on 2023-01-06 02:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('New', 'New'), ('Old', 'Old')], max_length=180)),
                ('information', models.TextField()),
                ('description', models.TextField()),
                ('stock', models.CharField(choices=[('IN STOCK', 'IN STOCK'), ('OUT OF STOCK', 'OUT OF STOCK')], max_length=200)),
                ('status', models.CharField(choices=[('PUBLISH', 'PUBLSH'), ('PUBLISH', 'PUBLISH')], max_length=200)),
